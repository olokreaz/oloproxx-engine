 ...
 */
API void log_set_global_logger( ILogger *logger );
 ...
 */
API void log_set_global_logger_default( );
 ...
 */
API void log_global_logger_finish( );
 ...
 */
API ILogger *log_get_scope_logger( );
 ...
 * @see CLogScope
 */
API void log_set_scope_logger( ILogger *logger );
 ...
 */
API std::unique_ptr< ILogger > log_logger_android( );
 ...
 */
API std::unique_ptr< ILogger > log_logger_collection( std::vector< std::shared_ptr< ILogger > > &&vpLoggers );
 ...
 */
API std::unique_ptr< ILogger > log_logger_file( IOHANDLE file );
 ...
 */
API std::unique_ptr< ILogger > log_logger_stdout( );
 ...
 */
API std::unique_ptr< ILogger > log_logger_windows_debugger( );
 ...
 */
API std::unique_ptr< ILogger > log_logger_noop( );
...
public:
	CLogScope( ILogger *logger ) : old_scope_logger( log_get_scope_logger( ) ), new_scope_logger( logger )
	{
